...
if(isset($_POST['signin']))
{
    ...
    $key="SELECT * FROM admintbl where a_email='$username'and a_password='$password'";
    $eqr=mysqli_query($con,$key);
    $check=$eqr->fetch_assoc();
    if($check)
    {
        echo $a_id=$check['a_id'];
        echo $_SESSION['a_id']=$a_id;
        echo "<script>window.location.replace('Admin_DashBoard/dash.php');</script>";
    }
    else
    {
...
<head>
    ...
    <title>Sign in - Admin | Hephares</title>
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/admin-signin-image.jpg" alt="sign up image"></figure>
                        <a href="register_rec.php" class="signup-image-link">Create an account</a>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Admin Entry</h2>
